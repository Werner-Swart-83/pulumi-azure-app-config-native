...
{
    [AzureAppConfigResourceType("azure-app-config:index:RandomComponent")]
    public partial class RandomComponent : global::Pulumi.ComponentResource
    {
        ...
        public RandomComponent(string name, RandomComponentArgs args, ComponentResourceOptions? options = null)
            : base("azure-app-config:index:RandomComponent", name, args ?? new RandomComponentArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
